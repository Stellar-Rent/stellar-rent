...
export async function createPropertyListing(
  ...
  try {
    ...
    const tx = new StellarSdk.TransactionBuilder(account, {
      ...
      .addOperation(
        contract.call('create_listing', propertyIdScVal, dataHashScVal, ownerScVal)
      )
      .setTimeout(30)
      .build();
...
export async function updatePropertyListing(
  ...
  try {
    ...
    const tx = new StellarSdk.TransactionBuilder(account, {
      ...
      .addOperation(
        contract.call('update_listing', propertyIdScVal, dataHashScVal, ownerScVal)
      )
      .setTimeout(30)
      .build();
...
export async function updatePropertyStatus(
  ...
  try {
    ...
    const tx = new StellarSdk.TransactionBuilder(account, {
      ...
      .addOperation(
        contract.call('update_status', propertyIdScVal, ownerScVal, statusScVal)
      )
      .setTimeout(30)
      .build();
...
export async function getPropertyListing(propertyId: string): Promise<PropertyListing | null> {
  ...
  try {
    ...
    const tx = new StellarSdk.TransactionBuilder(account, {
      ...
      .addOperation(
        contract.call('get_listing', propertyIdScVal)
      )
      .setTimeout(30)
      .build();

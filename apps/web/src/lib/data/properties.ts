...
export const MOCK_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    price: 6000,
    images: ["/images/house2.jpg", "/images/house1.jpg", "/images/house3.jpg"],
    rating: 4.8,
    reviewCount: 89,
    ...
    bedrooms: 4,
    bathrooms: 3,
    amenities: ["Wi-Fi", "Pool", "Air conditioning", "Fully equipped kitchen", "Free parking", "Garden", "BBQ area"],
    description:
  ...
  },
  {
    ...
    price: 4500,
    images: ["/images/house3.jpg", "/images/house4.jpg"],
    rating: 3.9,
    reviewCount: 45,
    ...
    description: "Comfortable and cozy bedroom suite perfect for couples. Clean, modern, and well-located.",
    policies: {
  ...
  },
  {
    ...
    price: 5600,
    images: ["/images/house4.jpg", "/images/house5.jpg", "/images/house1.jpg"],
    rating: 4.5,
    reviewCount: 67,
    ...
    description: "Elegant studio apartment with modern amenities and a beautiful balcony overlooking the city.",
    policies: {
      cancellation: "Free cancellation up to 48 hours before check-in",
      checkIn: "3:00 PM - 9:00 PM",
      checkOut: "11:00 AM",
  ...
  },
  {
    ...
    price: 2100,
    images: ["/images/house5.jpg", "/images/house2.jpg"],
    rating: 4.2,
    reviewCount: 33,
    ...
    description: "Charming loft with a fully equipped kitchen and rustic charm. Great for longer stays.",
    policies: {
  ...
  },
  {
    ...
    price: 6500,
    images: ["/images/house.jpg", "/images/house1.jpg", "/images/house3.jpg"],
    rating: 4.7,
    reviewCount: 78,
...
export const MOCK_REVIEWS: Record<string, PropertyReview[]> = {
  "1": [
    ...
    },
    {
      ...
      rating: 5,
      date: "2024-01-05",
      comment: "Perfect for our family vacation. The amenities were top-notch and the neighborhood was very safe.",
      verified: true,
      helpful: 15,
    },
  ],

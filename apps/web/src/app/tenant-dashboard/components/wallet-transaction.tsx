...
import { Wallet, Clock, CreditCard, Download } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-white mt-1">Manage your balance and transaction history</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        <div className="bg-white dark:bg-[#0B1D39] rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Available Balance</p>
              <p className="text-3xl font-bold text-gray-900 dark:text-white">${walletBalance.toFixed(2)}</p>
            </div>
        ...
        <div className="bg-white dark:bg-[#0B1D39] rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white">${pendingTransactions.toFixed(2)}</p>
            </div>
      ...
      <div className="bg-white dark:bg-[#0B1D39] rounded-xl shadow-lg overflow-hidden">
        ...
        {transactions.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-white">Your transaction history will appear here</p>
          </div>
        )}
      </div>
    </div>

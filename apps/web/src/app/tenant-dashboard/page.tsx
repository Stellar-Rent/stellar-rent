...
import { transformToLegacyBooking, transformToLegacyUser, transformFromLegacyUser } from "@/types";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <RefreshCw className={`w-6 h-6 ${(isLoadingBookings || isLoadingProfile || isLoadingWallet) ? 'animate-spin' : ''}`} />
              </button>
          ...
          <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  <RefreshCw className={`w-4 h-4 mr-2 ${isLoadingBookings ? 'animate-spin' : ''}`} />
                  Refresh
                </button>
              </div>
            </div>
                ...
                {filteredBookings.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-white">
                      {bookings.length === 0 ? "You don't have any bookings yet" : "Try adjusting your search or filters"}
                    </p>
                  </div>
                )}
              </>
